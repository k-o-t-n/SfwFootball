...
namespace Links
{
    ...
    public static readonly string sfw_football_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/sfw-football.min.js") ? Url("sfw-football.min.js") : Url("sfw-football.js");
...
public const string sfw_football_js = "~/Scripts/sfw-football.js"; 
